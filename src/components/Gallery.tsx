...
import myvideo4 from "@/assets/burger video.mp4";
import b1Img from "@/assets/b1.jpeg";
import nashvilleImg from "@/assets/nashville mariena.jpeg";
import w2Img from "@/assets/w2.png";
import burgerImg from "@/assets/burger.jpg";
import chickenwingsImg from "@/assets/chicken wings.jpg";
import shake1Img from "@/assets/shake1.png";
...
const Gallery = () => {
  ...
  return (
    <section id="gallery" className="py-20">
      ...
      <Helmet>
        <title>Food Gallery | Abela Burger</title>
        <meta
          name="description"
          content="Explore Abela Burger’s food gallery with mouth-watering chicken wings, juicy burgers, loaded fries, refreshing shakes, and more. Crafted fresh, served with love."
        />
      </Helmet>
