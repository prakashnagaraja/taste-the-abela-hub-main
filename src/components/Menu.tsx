...
//                 <h4 className="font-semibold text-foreground text-lg mb-2">{item.name}</h4>
//                 {item.description && (
...
//           <Button 
//             size="lg" 
//             className="bg-primary hover:bg-primary/90 text-white px-12 py-3 rounded-full text-lg font-semibold"
//             onClick={() => window.open('https://wa.me/918925503875', '_blank')}
//           >
//             ORDER NOW
//           </Button>
